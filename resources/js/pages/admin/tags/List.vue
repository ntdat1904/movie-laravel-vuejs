        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <b-col md="12" class="text-right">
                    ...
                    <button class="btn bold yellow border-global" style="margin: 10px 15px 0 0" @click="getTags()">
                        Search
                    </button>
                </b-col>
            </div>
            <b-col md="12">
                ...
                <b-col md="6" class="my-1  text-right">
                    <div class="btn-group">
                        <router-link :to="{name:'admin.tag.create'}" class="nav-link">
            ...
            >
                ...
                <template slot="actions" slot-scope="data">
                    <div class="actions">
                        <router-link
                            :to="{ name: 'admin.tag.edit', params: { id: data.item.id }}"
    ...
    export default {
        ...
        data() {
            return {
                ...
                paginate: {
                    ...
                    from: 1,
                    last_page: 3,
                    path: "http://movie.test/api/auth/tag",
                    prev_page_url: null,
                    to: 1,
                    page: 1,
                },
        ...
        methods: {
            ...
            getTags() {
                ...
                this.axios.get('auth/tag', {params: query})
                    .then((res) => {
                        let data = [];
                        data = res.data.tags;
            ...
            selectAllchange() {
                if (this.arrId.length === this.tags.length) {
                    this.arrId = []
                }
            },
        ...
        computed: {
            ...
            selectAll: {
                get: function () {
                    return this.tags ? this.arrId.length == this.tags.length : false;
                },
                set: function (value) {
                    var selected = [];
